                ...
                try:
                    ...
                    for disease in diseases :
                        try:
                            ...
                            print ('error:{}, url:{}'.format(e, disease['url']))
                except Exception as e :
                    print (e)
                    continue
...
class SpiderTestsheet :
    ...
    def get_contents(self, url):
        ...
        div = soup.find_all(['p', 'h2'])
        tags = div.find_all(['p', 'h2'])
        content = ''
        for tag in tags :
            text = tag.get_text()
            if '怎样看化验单专题' ==  text:
    ...
    def save(self, name, type1, type2, content):
    ...
    def perform(self):
        try:
            ...
            for item in items :
                ...
                self.save(item['name'], item['type'], content)
